...
export const SEVERITY_LABELS: Record<string, string> = {
  high: "Anomalía", ok: "Sin problemas", warn: "Atención", bad: "Alerta", info: "Dato del día",
};

export const INSIGHT_ICONS: Record<string, string> = {
  high: `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>`,
